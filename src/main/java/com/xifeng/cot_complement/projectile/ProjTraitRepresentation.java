...
@ZenClass("mods.cc.tic.ProjTrait")
@ZenRegister
@ModOnly("tconstruct")
public class ProjTraitRepresentation {
    ...
    public TraitDataRepresentation getData(IItemStack itemStack) {
        if(trait instanceof ProjectileModifierTrait) {
            return new TraitDataRepresentation(((ProjectileModifierTrait) trait).getData(CraftTweakerMC.getItemStack(itemStack)));
        }
